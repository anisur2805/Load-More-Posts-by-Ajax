...
function ar_customize_function() {
    wp_enqueue_script( 'ar-customizer-js', get_theme_file_uri( '/assets/js/ar-customizer.js' ), [ 'jquery', 'customize-preview' ], time(), true );
}
...
function ar_customizer_settings( $wp_customizer ) {
    $wp_customizer->add_section( 'cus_services', [
        'title'    => __( 'Services', 'mercurygate' ),
        'priority' => '30',
    ] );

    $wp_customizer->add_setting( 'ar_services_heading', [
        'dafault'   => 'Our Services',
        'transport' => 'postMessage',
    ] );
    $wp_customizer->add_control( 'ar_services_heading_ctrl', [
    ...
    $wp_customizer->add_setting( 'ar_services_subheading', [
        'dafault'   => 'Lorem ipsum doler sit amet',
        'transport' => 'refresh',
        // 'type'=>'option'
    ] );
    $wp_customizer->add_control( 'ar_services_subheading_ctrl', [
    ...
    $wp_customizer->add_setting( 'ar_services_display_subheading', [
        'default'   => 1,
        'transport' => 'refresh',
    ] );
    $wp_customizer->add_control( 'ar_services_display_subheading_ctrl', [
    ...
    // Set Column
    $wp_customizer->add_setting( 'ar_services_column_in_row', [
        'default'   => '4',
        'transport' => 'refresh',
    ] );
    $wp_customizer->add_control( 'ar_services_column_in_row_ctrl', [
    ...
    //Other Section
    $wp_customizer->add_section( 'cus_other', [
        'title'    => __( 'Other Panel', 'mercurygate' ),
        'priority' => '40',
    ] );
    $wp_customizer->add_setting( 'ar_other_heading', [
        'default'   => 'other2',
        'transport' => 'refresh',
    ] );
    $wp_customizer->add_control( 'ar_other_heading_ctrl', [
    ...
    $wp_customizer->add_setting( 'ar_services_icon_color', [
        'default'   => '#f00',
        'transport' => 'postMessage',
    ] );
    $wp_customizer->add_control( new WP_Customize_Color_Control( $wp_customizer, 'ar_services_icon_color_ctrl', [
    ...
    // Customizer Page
    $wp_customizer->add_section( 'cus_customizer', [
    ...
    $wp_customizer->add_setting( 'ar_customizer_heading', [
        'default'   => 'About Page Heading',
        'transport' => 'refresh',
    ] );
    $wp_customizer->add_control( 'ar_customizer_heading_ctrl', [
